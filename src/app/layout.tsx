...
export const metadata: Metadata = {
  title: "Relisted Labels - Early Access for Listers",
  description:
    "Join Relisted Labels as an early access lister. List your fashion pieces and earn by sharing your wardrobe with others.",
